...
let SummerNoteConfig = {
  ...
  defaultToolbar: function (loadDefault) {
    ...
    let toolbar = [
        ...
        ['style', ['style', 'styleP', 'styleH1', 'styleH2', 'styleH3', 'styleH4', 'styleH5', 'styleH6', 'transSelected']],
        ['font', ['undo', 'bold', 'italic', 'underline', 'clear']],
        //['fontname', ['fontname']],
        ['color', ['color']],
        ['para', ['ul', 'ol', 'paragraph']],
        //['table', []],
        ['insert', ['hr', 'link', 'picture', 'video', 'table', 'IframePrompt', 'FileUploader', 'CodeInserter', 'insertMore']],

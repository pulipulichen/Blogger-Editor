...
let SummerNoteConfig = {
  ...
  defaultToolbar: function (loadDefault) {
    ...
    let toolbar = [
        ...
        ['insertStart', ['buttonInsertMore', 'buttonInsertHR', 'buttonInsertCode', 'buttonFilesUploader']],
        ['insertEnd', ['buttonOpenCoverBuilder', 'buttonAbstractInserter']],
        ['clear', ['undo', 'clear']],
        ['style', ['style', 'forecolor', 'backcolor']],
        ...
        //['table', []],
        ['insert', ['link', 'picture', 'table', /*'insertTable',*/  /*'CodeInserter', 'SaveSnippet'*/ 'insertGroup']],
        ...
        ['read', ['ReadAloudSpeedGroup', 'ReadAloud']],
      ]
  ...
  popoverLink: function () {
    return [
      ['link', ['linkDialogShow', 'unlink', 'copyLink', 'insertScreenshot']],
      ['remove', ['removeLink']]
    ]
  },
  popoverAir: function () {
